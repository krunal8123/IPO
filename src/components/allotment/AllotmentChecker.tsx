        ...
        {batchResults.length > 0 && (
          <div className="space-y-2.5">
            ...
            {batchResults.map((br) => (
              <div
                key={br.panCard.id}
                className={`rounded-xl border p-3 sm:p-3.5 transition-all ${br.loading
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="shrink-0 text-right">
                    {br.loading ? (
                      ...
                      <span className={`text-[11px] font-extrabold uppercase px-2.5 py-1 rounded-full shadow-xs ${br.result?.status === 'Allotted'
    ...
    <div className="space-y-5 sm:space-y-6">
      ...
      <div className="flex items-center justify-between p-1.5 rounded-2xl bg-slate-100 dark:bg-slate-800/80 border border-slate-200/80 dark:border-slate-700/80 gap-2">
        <button
          ...
          className={`flex-1 py-2.5 px-4 text-center text-xs font-bold rounded-xl transition-all flex items-center justify-center gap-2 cursor-pointer ${allotmentViewMode === 'check'
        ...
        <button
          ...
          className={`flex-1 py-2.5 px-4 text-center text-xs font-bold rounded-xl transition-all flex items-center justify-center gap-2 cursor-pointer ${allotmentViewMode === 'family'
            ? 'bg-white dark:bg-slate-900 text-indigo-600 dark:text-indigo-400 shadow-xs'
            : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'
            }`}
        >
          ...
          <div className="lg:col-span-2 glass-card rounded-2xl p-4 sm:p-6 border border-slate-200 dark:border-slate-800 space-y-5">
                    ...
                    {recentAllotmentShortcuts.map(opt => {
                      ...
                      return (
                        <button
                          ...
                          className={`px-3 py-2 rounded-xl text-xs font-bold whitespace-nowrap shrink-0 transition-all cursor-pointer flex items-center gap-2 border min-h-[38px] active:scale-95 ${isSelected
                        ...
                        >
                          ...
                          <span className={`text-[9px] font-extrabold px-1.5 py-0.5 rounded-md ${isSelected
            ...
            <div className="flex lg:hidden items-center p-1 rounded-2xl bg-slate-100 dark:bg-slate-800/90 border border-slate-200 dark:border-slate-700">
              <button
                ...
                className={`flex-1 py-2.5 px-3 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer min-h-[40px] ${mobileTab === 'single'
                  ? 'bg-white dark:bg-slate-900 text-indigo-600 dark:text-indigo-400 shadow-xs'
              ...
              <button
                ...
                className={`flex-1 py-2.5 px-3 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer min-h-[40px] ${mobileTab === 'batch'
                  ? 'bg-white dark:bg-slate-900 text-indigo-600 dark:text-indigo-400 shadow-xs'
                  : 'text-slate-600 dark:text-slate-400 hover:text-slate-900'
                  }`}
              >
              ...
              <button
                type="button"
                onClick={() => setMobileTab('pans')}
                className={`py-2.5 px-3 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1.5 cursor-pointer min-h-[40px] ${mobileTab === 'pans'
                  ? 'bg-white dark:bg-slate-900 text-indigo-600 dark:text-indigo-400 shadow-xs'
                  : 'text-slate-600 dark:text-slate-400 hover:text-slate-900'
                  }`}
              >
            ...
            <div className={mobileTab === 'single' ? 'block' : 'hidden lg:block'}>
                    ...
                    {[
                      ...
                      return (
                        <button
                          ...
                          className={`py-2.5 px-2 text-xs font-bold rounded-xl border transition-all cursor-pointer flex items-center justify-center gap-1.5 min-h-[44px] active:scale-95 ${isSelected
                    ...
                    <div className="flex items-center gap-1.5 overflow-x-auto pb-1 no-scrollbar -mx-4 px-4 sm:mx-0 sm:px-0 touch-pan-x">
                      {pans.map(p => (
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-xl text-xs font-mono font-bold whitespace-nowrap shrink-0 transition-all cursor-pointer border flex items-center gap-1.5 min-h-[36px] active:scale-95 ${queryValue === p.pan
              ...
              {/* Result Card */}
              {result && (
                <div className={`mt-5 p-4 sm:p-5 rounded-2xl border transition-all animate-fade-in ${result.status === 'Allotted'
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-2.5 mb-3">
                    ...
                    <div className="self-start sm:self-auto shrink-0">
                      <span className={`inline-flex items-center text-xs font-black uppercase px-3 py-1.5 rounded-full shadow-xs ${result.status === 'Allotted'
                        ? 'bg-emerald-500 text-white'
                        : result.status === 'Not Allotted'
                          ? 'bg-rose-500 text-white'
                          : result.status === 'Under Process'
