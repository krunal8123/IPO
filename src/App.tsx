...
import { mockIpoList, mockBuybacks, mockCalendarEvents } from './data/mockIpoData';
...
export const App: React.FC = () => {
  ...
  const [ipos, setIpos] = useState<IpoItem[]>(mockIpoList);
  ...
  const syncLiveData = async () => {
    setIsSyncing(true);
    try {
      const res = await liveIpoService.getLiveIpos();
      setIpos(res.ipos);
